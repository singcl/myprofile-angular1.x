...
app.controller('ModalInstanceCtrl', ['$scope', '$modalInstance', 'items', 'title', function($scope, $modalInstance, items, title) {
    $scope.items = items;
    $scope.title = title;
    $scope.selected = {
        item: $scope.items[0]
...
app.controller('ModalDemoCtrl', ['$scope', '$modal', '$log', function($scope, $modal, $log) {
    $scope.title = "联系方式",
        $scope.items = ['电话:15881615657', 'QQ:1276837689', '微信:singcl008'];
